...
public class HFOModClientConfig {
    ...
    public static Screen createConfigScreen(Screen parent) {
        ...
        general.addEntry(entryBuilder
                .startTextDescription(Text.translatable("config.hardcore_fluid_overhaul.text.clientSettingsText"))
                .build()
        );
        general.addEntry(entryBuilder
                .startTextDescription(Text.translatable("config.hardcore_fluid_overhaul.text.emptyClientConfigText"))
                .build()
        );

        // Server Settings
        general.addEntry(entryBuilder
                .startTextDescription(Text.translatable("config.hardcore_fluid_overhaul.text.serverSettingsNoAccessText"))
    ...
    private static Requirement displayWhenLocalServer() {
        return HFOModClientConfig::isTrueSingleplayer;
    }

    private static Requirement displayWhenRemoteOrLAN() {
        return HFOModClientConfig::isNotTrueSingleplayer;
    }
